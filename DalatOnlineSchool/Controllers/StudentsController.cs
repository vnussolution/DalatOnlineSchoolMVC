...
namespace DalatOnlineSchool.Controllers
{
    public class StudentsController : Controller
    {
        ...
        public ActionResult Details(int? id)
        {
            ...
            //using query to call
            //string query = "SELECT * FROM Students WHERE ID = @p0";
           // Student studentSQL = db.Students.SqlQuery(query, id).SingleOrDefault();
        ...
        public ActionResult Create([Bind(Include = "LastName,FirstMidName,Email,EnrollmentDate")] Student student)
        {
            ...
            catch (RetryLimitExceededException dex)
            {
                ...
                ModelState.AddModelError("DexCreateStudent", "Unable to save changes. Try again, and if the problem persists see your system administrator.");
            }
        ...
        public ActionResult Edit([Bind(Include = "ID,LastName,FirstMidName,Email,EnrollmentDate")] Student student)
        {
            ...
            catch (RetryLimitExceededException dex)
            {
                ...
                ModelState.AddModelError("dexEditStudent", "Unable to save changes. Try again, and if the problem persists see your system administrator.");
            }
        ...
        public ActionResult Delete(int? id, bool? saveChangesError=false )
        {
            ...
            {
                ViewBag.ErrorMessage = "Delete failed. Try again please.";
            }
            Student student = db.Students.Find(id);
            if (student == null)
            {
